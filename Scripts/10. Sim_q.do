...
********************************************************************************
use "Out/simulated_mortality_data.dta", clear

confirm variable age
confirm variable sex
confirm variable rate_sim_loglin
confirm variable rank

********************************************************************************
* 1. CONVERT MORTALITY → SURVIVAL
********************************************************************************
gen surv = 100000 - rate_sim_loglin
...
********************************************************************************
save ///
"Out/mortality_bounds_by_age_sex_quintile_cohort_loglin.dta", ///
replace
...
confirm variable age
confirm variable sex
confirm variable rate_sim_shape
confirm variable rank

********************************************************************************
* 1. CONVERT MORTALITY → SURVIVAL
********************************************************************************
gen surv = 100000 - rate_sim_shape
label variable surv "Survival per 100,000"
...
********************************************************************************
save ///
"Out/mortality_bounds_by_age_sex_quintile_cohort_simshape.dta", ///
replace
